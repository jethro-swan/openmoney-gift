...
module.exports = Backbone.Collection.extend({
  ...
  getByAccount: function(accountModel){
    return Self.models.filter(function(model) {
      return (
        (accountModel.get('account') == model.get('from_account') && accountModel.get('account_namespace') == model.get('from_account_namespace')) ||
        (accountModel.get('account') == model.get('to_account') && accountModel.get('account_namespace') == model.get('to_account_namespace'))
      )
    })
  },
